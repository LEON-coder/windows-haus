...
$(function () {
    ...
    var carousel_nav_a = $('.carousel-nav-tabs-production a');
    ...
    owl.on('changed.owl.carousel',function (event) {
        carousel_nav_a.removeClass('active');
        $(".carousel-nav-tabs-production a[data-num=" + event.item.index + "]").addClass('active');
    })
})